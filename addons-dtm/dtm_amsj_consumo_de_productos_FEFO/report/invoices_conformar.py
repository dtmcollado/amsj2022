...
class ParticularReport(models.AbstractModel):
    ...
    def render_html(self, data=None):
        ...
        wizard = self.env['wizard.consumos_pdf_fefo'].browse(self._context.get('active_ids', []))
        ...
        docargs = {
            ...
            'docs': wizard,
            'report_title': 'Informe de consumos',
        ...
        return report_obj.render('dtm_amsj_consumo_de_productos_FEFO.invoices_conformar', docargs)
