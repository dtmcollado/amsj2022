-- Function: public.sp_reponer(integer, integer, character varying, character varying)

-- DROP FUNCTION public.sp_reponer(integer, integer, character varying, character varying);

CREATE OR REPLACE FUNCTION public.sp_reponer(
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION public.sp_reponer(integer, integer, character varying, character varying)
  OWNER TO odoo;
